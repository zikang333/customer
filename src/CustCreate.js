...
const CustCreate = () => {
    ...
    const handlesubmit=(e)=>{
      ...
      fetch("https://localhost:7066/api/Cust/AddPhone",{
        method:"POST",
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-12">
                                        <div className="form-group">
                                            ...
                                            <input required value={custId} onMouseDown={e=>valchange(true)} onChange={e=>namechange(e.target.value)} className="form-control"></input>
                                        {custId.length==0 && validation && <span className="text-danger">Enter the Customer ID</span>}
                                        </div>
                                    </div>
                                    ...
                                    <div className="col-lg-12">
                                        <div className="form-group">
                                            ...
                                            <input value={phoneNo} onChange={e=>phonechange(e.target.value)} className="form-control"></input>
                                        </div>
                                    </div>
